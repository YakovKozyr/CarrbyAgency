                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="blog_post">
                                <div class="post_img">
                                    <a href="index.html#"><img src="<?php bloginfo('template_directory') ?> /images/blog/blog-1.jpg" alt="img"></a>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog_post">
                                <div class="post_img">
                                    <a href="index.html#"><img src="<?php bloginfo('template_directory') ?> /images/blog/blog-2.jpg" alt="img"></a>
                                </div>
                                <div class="post_content">
                                    <div class="post_header">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog_post">
                                <div class="post_img">
                                    <a href="index.html#"><img src="<?php bloginfo('template_directory') ?> /images/blog/blog-3.jpg" alt="img"></a>
                                </div>
                                <div class="post_content">
                                    <div class="post_header">
